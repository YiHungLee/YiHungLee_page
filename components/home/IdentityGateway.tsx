  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-px bg-border-light dark:bg-darkMode-border">
          {identities.map((identity, index) => (
            <Link
              key={identity.id}
              to={identity.path}
              className="group relative bg-warmCream-100 dark:bg-darkMode-bg
            ...
            >
              ...
              <div className="p-12 md:p-16 lg:p-20 min-h-[500px] md:min-h-[600px]
                ...
                <div className="space-y-8">
                  ...
                  {/* Tagline */}
                  <div className="pt-8 border-t border-fine border-border-light dark:border-darkMode-border">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center gap-3
                    ...
                    <div className="h-px w-8 bg-ochre-500 dark:bg-darkMode-ochre
                                    transition-all duration-400
